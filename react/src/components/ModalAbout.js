...
export default function ModalResModalAboutervation(props) {
  return (
    <div className='text-dark'>
      ...
      <span className="btn text-secondary p-0" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
        {props.children}
      </span>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="staticBackdropLabel">A propos d'Hypnos</h5>
